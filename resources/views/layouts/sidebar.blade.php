<aside class="main-sidebar sidebar-light-primary elevation-4">
    <a href="{{ route('home') }}" class="brand-link bg-light">
        <img src="{{ asset('assets/logo-telsip.png') }}" alt="Logo" class="brand-text font-weight-light"style="max-width: 90px; max-height: 90px; margin-left: 65px;">
    </a>
